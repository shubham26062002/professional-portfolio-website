...
export const ContactForm = () => {
    ...
    return (
        <form className="mt-10 space-y-3 flex flex-col" onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <button className="uppercase text-sm tracking-widest flex items-center justify-center h-[3rem] w-[8rem] bg-gray-900 text-white rounded-full outline-none transition-all transform-gpu gap-2 hover:bg-gray-900/95 hover:scale-105 active:scale-100 active:bg-gray-900/95 focus-visible:outline-none focus-visible:bg-gray-900/95 focus-visible:scale-105 focus-visible:ring-1 focus-visible:ring-gray-900/50 focus-visible:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed leading-none" type="submit" disabled={form.formState.isSubmitting}>
                Submit
